...
extlinks = {
    "issue": ("https://github.com/AnonymousDapper/aiotnb/issues/%s", "GH-"),
}
...
project = "aiotnb"
copyright = "2021-present, AnonymousDapper"
...
version = ""
with open("../aiotnb/__init__.py") as f:
...
resource_links = {
    ...
    "discussions": "https://github.com/AnonymousDapper/aiotnb/discussions",
    "examples": f"https://github.com/AnonymousDapper/aiotnb/tree/{branch}/examples",
}
...
latex_documents = [
    ("index", "aiotnb.tex", "aiotnb Documentation", "AnonymousDapper, Aareon, Abhay", "manual"),
]
...
man_pages = [("index", "aiotnb", "aiotnb Documentation", ["AnonymousDapper", "Aareon", "Abhay"], 1)]
...
texinfo_documents = [
    (
        "index",
        "aiotnb",
        "aiotnb Documentation",
        "AnonymousDapper, Aareon, Abhay",
        "aiotnb",
